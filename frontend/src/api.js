...
export const api = {
  ...
  getStudentTutors: (id) => request(`/students/${id}/tutors`),
  addStudentTutor: (data) => request('/student-tutors', { method: 'POST', body: data }),
  removeStudentTutor: (id) => request(`/student-tutors?id=${id}`, { method: 'DELETE' }),
