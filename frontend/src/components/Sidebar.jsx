...
const menuItems = {
  ...
  superadmin: [
    ...
    { key: 'attendance', label: 'Attendance', icon: 'check-square' },
    { key: 'staffattendance', label: 'Staff Attendance', icon: 'clock' },
    { key: 'payroll', label: 'Salary / Payroll', icon: 'dollar-sign' },
    { key: 'reports', label: 'Reports', icon: 'bar-chart' },
...
const iconMap = {
  ...
  tag: <Svg><path d="M20.59 13.41 12 22l-9-9V3h10l7.59 7.59a2 2 0 0 1 0 2.82z" /><line x1="7.5" y1="7.5" x2="7.51" y2="7.5" /></Svg>,
